  ...
  public void start(Stage primaryStage) {
    ...
    btn.setOnAction(new EventHandler<ActionEvent>() {
      public void handle(ActionEvent event) {
        ...
        //actiontarget.setText("sup");
        try {
          Game game = new Game("Side1", odds1, "Side2", odds2);
          System.out.println(new Double(game.side1Prct()));
          System.out.println(new Double(game.side2Prct()));
          winPrct1.setText(String.format("%.2f", new Double(game.side1Prct()) * 100));
          winPrct2.setText(String.format("%.2f", new Double(game.side2Prct()) * 100 ));
          betPrct1.setText(String.format("%.2f", new Double(LineOdds.betProb(odds1)) * 100));
          betPrct2.setText(String.format("%.2f", new Double(LineOdds.betProb(odds2)) * 100));
          
          vig.setText(String.format("%.4f", new Double(game.vig())));
